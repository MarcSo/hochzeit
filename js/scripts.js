$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('info', '<strong>Einen Moment bitte :-)</strong> Dein Feedback wird registriert!'));
        $.post('https://script.google.com/macros/s/AKfycby7ZNPxwUmZuC6jJgCvqCEaD9cDW4y-dYmFuslst1eJxOCDtfd032_O9g/exec', data)
            .done(function (data) {
                console.log(data);
            ...
            .fail(function (data) {
                console.log(data);
                $('#alert-wrapper').html(alert_markup('danger', '<strong>Entschuldigung!</strong> Da ist etwas schiefgelaufen!. '));
            });
    });
...
// Google map
function initMap() {
    var location = {lat: 51.61258060859348, lng: 6.941345950572245};
...
function initBBSRMap() {
    var la_fiesta = {lat: 51.61258060859348, lng: 6.941345950572245};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
